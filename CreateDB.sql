...
VALUES ('הענקת דרגה למניב', '29/03/2020 09:00:00', '29/03/2020 10:00:00', 4),
       ('פסח', '08/04/2020 00:00:00', '15/04/2020 00:00:00', 3),
       ('סטטוס מפעל הספקטרום', '16/04/2020 09:00:00', '16/04/2020 10:00:00', 2);

INSERT INTO users(name, user_name, password, birthday)
VALUES ('רועי רום', 'roeirom', 'rr123456', '18/06/2000 00:00:00'),
       ('מאיה ששון', 'mayasasson', 'ms123456', '14/05/1999 00:00:00'),
       ('רוני שוורץ', 'ronischwartz', 'rs123456', '14/12/2000 00:00:00'),
       ('אוראל לוי קרוואני', 'orelkaravani', 'ok123456', '14/12/1993 00:00:00'),
       ('רועי מניב', 'roymaniv', 'rm123456', '05/07/2000 00:00:00');